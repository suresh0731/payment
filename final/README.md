...
| Component | Status |
|-----------|--------|
| `51786-idp-extraction-service` | Built (sync `/v1/extract`, mock mode, `id-payment-v1` template) — **one change pending:** `initiationDetail` must become an array. Blocks the gateway work that depends on it |
