...
> **Status:** UX review / finalize before build  
> **Created:** 2026-07-30 · **Revised:** 2026-07-30 (dashboard tabs + modal)  
> **Related:** [IDP_Document_Ingestion_Design.md](./IDP_Document_Ingestion_Design.md) · [after_ocr-llm-output.json](./after_ocr-llm-output.json)
...
Fields: same as [after_ocr-llm-output.json](./after_ocr-llm-output.json) (TransactionDetails, DebitDetails, CreditDetails).
...
### 8.6 Backend / workflow (unchanged from technical design)

Upload still starts `IDP_Document_Ingestion`; checker approve still triggers `IAP_ID_IDP_Trigger`. UI change is **placement on landing tabs**, not workflow change.
